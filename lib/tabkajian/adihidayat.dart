...
class AdiHidayat extends StatefulWidget {
  @override
  _AdiHidayatState createState() => _AdiHidayatState();
}

class _AdiHidayatState extends State<AdiHidayat> {
  ...
  Future<void> fetchYouTubeVideos() async {
    final String apiUrl = 'https://www.googleapis.com/youtube/v3/search?'
        'part=snippet'
        '&channelId=UC5KW9VowHehb_jHAhDMZpEQ'
        '&maxResults=10'
        '&order=date'
            ...
            child: Row(
              children: [
                ClipRRect(
                  ...
                  child: Image(
                    width: 40,
                    image: AssetImage('assets/ulama/ch4.png'),
                  ),
                ),
                SizedBox(width: 10),
                Text(
