...
class JedaNulis extends StatefulWidget {
  @override
  _JedaNulisState createState() => _JedaNulisState();
}

class _JedaNulisState extends State<JedaNulis> {
  ...
  Future<void> fetchYouTubeVideos() async {
    final String apiUrl = 'https://www.googleapis.com/youtube/v3/search?'
        'part=snippet'
        '&channelId=UCp7hJfiiocdY085XnWVrp2Q'
        '&maxResults=10'
        '&order=date'
            ...
            child: Row(
              children: [
                ClipRRect(
                  ...
                  child: Image(
                    width: 40,
                    image: AssetImage('assets/ulama/ch1.png'),
                  ),
                ),
                SizedBox(width: 10),
                Text(
