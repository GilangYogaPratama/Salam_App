...
import 'package:salam_apps/widgets/comment.dart';
import 'dart:convert';
...
class PemudaTersesat extends StatefulWidget {
  @override
  _PemudaTersesatState createState() => _PemudaTersesatState();
}

class _PemudaTersesatState extends State<PemudaTersesat> {
  ...
  Future<void> fetchYouTubeVideos() async {
    final String apiUrl = 'https://www.googleapis.com/youtube/v3/search?'
        'part=snippet'
        '&channelId=UCXJkj7Q90olqHe6TvLeTOmg'
        '&maxResults=10'
        '&order=date'
            ...
            child: Row(
              children: [
                ClipRRect(
                  ...
                  child: Image(
                    width: 40,
                    image: AssetImage('assets/ulama/ch2.png'),
                  ),
                ),
                SizedBox(width: 10),
                Text(
